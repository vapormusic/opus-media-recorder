...
var DataView = require('./DataViewUtils.js');
const BYTES_PER_SAMPLE = 3; // This means 16-bit wav file.
  ...
  encode (channelBuffers) {
    ...
    for (let ch = 0; ch < this.config.channelCount; ch++) {
      ...
      for (let i = 0; i < length; i++) {
        ...
        encodedView.setInt24(offset, sample | 0, true);
      }
    }
